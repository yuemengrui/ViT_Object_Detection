...
class ViTDetDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            h, w = img.shape[:2]
            x1 = target_box[0] * scale / w
            y1 = target_box[1] * scale / h
            x2 = target_box[2] * scale / w
            y2 = target_box[3] * scale / h
            ...
            label = torch.from_numpy(np.array([x1, y1, x2, y2]))
...
#     # break
#
#     img, target, label, center_x, center_y = dataset[0]
#     print(img.shape)
#     print(target.shape)
#
